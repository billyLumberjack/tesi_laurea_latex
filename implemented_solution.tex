...
It's a 3-tier deployment architecture based on Microsoft .NET platform which main components are,
\begin{itemize}
    \item WebBased UI and REST \textit{- client interface}
    ...
    \item RDBMS (Relational Database Management System) \textit{- Amazon Aurora}
\end{itemize}
