...
A .NET based plugin for Cardioline softwares, called \textit{CdaHelper} has been brought out: given a reviewed cardiologic exam as an SCP file it outputs the associated CDA R2.\\
Starting from a minimised CDA, where common values for general electrocardiograms are already stored in, and a dictionary data structure, holding specific exam releted data are, the final CDA document is built and ready for the EHR.
To keep this mechanism as elestic and maintainable as possible, every piece of information injected follows a predefined rule inside a configuration file.\\
Currently these are ECG-SCP tags that have been mapped to the CDA ones:
\begin{scriptsize}
...
\begin{lstlisting}[caption=Some caption,label=lst:ref]
<?xml version="1.0"?>
<?xml-stylesheet type="text/xsl" href="CDAit.xsl"?>
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:voc="urn:hl7-org:v3/voc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 CDA.xsd">
  ...
  <!--HL7 Italia richiede che l’attributo root sia di tipo OID, e che non sia usato per identificare “di per sé” l’istanza del documento, ma l’organizzazione che assicura l’univocità dell’OID.-->
    ...
    <assignedAuthor>
      ...
      <assignedPerson>
        <name>
          ...
          <given>Stefania Marchesi</given>
        </name>
      </assignedPerson>
    </assignedAuthor>
  </author>
  <custodian typeCode="CST">
    <!--Il custodian è l’organizzazione responsabile della conservazione dell’originale del 1350 documento, al momento della generazione, esso registra usualmentel’identificativo della Struttura Sanitaria a cui appartiene l’author. Normalmente identifica la struttura presso la quale è generato il documento (cioè la struttura in cui ha luogo il contatto sanitario del paziente), il custodian potrà 1355 essere anche la stessa organizzazione relativa all’AREA-DOMINIO, utilizzando un modello centralizzato. ClinicalDocument.custodian secondo le specifiche di CDA R2 è un elemento obbligatorio ed è unico.-->
  ...
  <!--Sezione per documentare la richiesta di prestazione -->
  <inFulfillmentOf>
    <order>
      <!-- ID del documento relativo alla richiesta (ID-Prestazione-GLCDA) -->
    ...
    <structuredBody>
      <component>
        <section>
          ...
          <title>L’elemento section/text rappresenta il blocco narrativo e contiene le informazioni human- readable della sottosezione del Referto di Medicina di Laboratorio</title>
