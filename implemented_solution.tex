...
\label{section:interoperability_of_digital_electrocardiograms_data}
...
A specific module has been developed to prepare reviewed electrocardiograms for Electronic Healt Record any time a user with review priviledges confirm his/her analysis a compliant to Italian EHR (aka FSE)CDA document (details at \ref{section:interoperability_of_digital_electrocardiograms_data}) is then built and and eventually submitted. (EHR - Electronic Healt Record and FSE - Fascicolo Sanitario Elettronico were defined in \ref{subsection:electronic_health_record})
