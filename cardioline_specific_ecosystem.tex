...
\paragraph{Functional and Non functional requirements} As reported above, Cardioline together with FBK came up with additional features which the current version of their system does not support.\\The following are the functional requirements.
...
\subparagraph{Legal constraints}
...
Amazon was choosen as service provider because ot not only offers storage servers located in Europe but they are also CISPE certificated: they ensure data be processed and saved into European Union lying servers.\\
