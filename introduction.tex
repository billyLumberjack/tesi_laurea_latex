...
The main differences among them is who is granted the access to a specific cloud infrastructure.
...
These are standardized way of integrating web-based applications using XML, SOAP, WSDL and UDDI open standards over an internet protocol backbone.\cite{webservice}
\subsection{Definition}
\paragraph{REST}
