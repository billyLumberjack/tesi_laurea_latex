...
From an economic point of view this technology is particularly feasible for smaller companies and start-up, which want to avoid large up-front IT infrastructure investments \cite{CloudComputingModels}.
The figure \ref{fig:saas_paas_iaas} shows a view of customer vs provider roles among different service models.

\begin{figure}[h]
    \includegraphics[width=\textwidth]{img/saas_paas_iaas}
...
Here are presented the typical ways in which cloud services are made available to customers.
These service models are often interdependent and synergetic each other.
\paragraph{Paas}
