...
The main approaches to implement web services are two: the first one follows the REpresentational State Transfert (REST) principles where everything is built around the concept of resource, the last one is the Simple Object Access Protocol (SOAP), here the core the 
\subsection{Definition}
\paragraph{REST}
