...
\end{itemize}
\cite{foster}
From an economic point of view this technology is particularly feasible for smaller companies and start-up, which want to avoid large up-front IT infrastructure investments. In figure \ref{fig:saas_paas_iaas}
