...
Differently from previously defined models, serverless computing (sometimes referred to as FaaS: Function as a Service \cite{ServerlessComputing}) enables developer to implement server-side logic and execute it in a stateless container that are event-triggered.\\
...
Furthermore the code does not require to be specifically built for a framework or library \cite{MartinServerless}.
